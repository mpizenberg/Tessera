...
const healthFooter = {
  ...
  // Koios usage of the last refresh vs the per-refresh budget.
  koiosRefresh: "Koios {calls}/{limit}",
  koiosRefreshTitle:
    "Koios calls made by the last refresh, against the per-refresh budget",
  ...
  koiosDailyTitle: "Koios calls across all refreshes of the last 24 hours",
  // Refresh outcomes.
