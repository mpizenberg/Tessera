...
var require_buffer = __commonJS({
  "node_modules/buffer/index.js"(exports) {
    ...
    Buffer13.prototype.compare = function compare(
      target,
      start,
      end,
      thisStart,
    ...
    Buffer13.prototype.lastIndexOf = function lastIndexOf(
      val,
      byteOffset,
      encoding,
    ) {
    ...
    function utf8Write(buf, string, offset, length) {
      return blitBuffer(
        utf8ToBytes3(string, buf.length - offset),
        buf,
        offset,
        length,
      );
    ...
    Buffer13.prototype.write = function write(
      string,
      offset,
      length,
      encoding,
    ...
    Buffer13.prototype.readUintLE = Buffer13.prototype.readUIntLE =
    ...
    Buffer13.prototype.readUintBE = Buffer13.prototype.readUIntBE =
    ...
    Buffer13.prototype.readUint8 = Buffer13.prototype.readUInt8 =
      function readUInt8(offset, noAssert) {
        offset = offset >>> 0;
        if (!noAssert) checkOffset(offset, 1, this.length);
        return this[offset];
      };
    Buffer13.prototype.readUint16LE = Buffer13.prototype.readUInt16LE =
      function readUInt16LE(offset, noAssert) {
        offset = offset >>> 0;
        if (!noAssert) checkOffset(offset, 2, this.length);
        return this[offset] | (this[offset + 1] << 8);
      };
    Buffer13.prototype.readUint16BE = Buffer13.prototype.readUInt16BE =
      function readUInt16BE(offset, noAssert) {
        offset = offset >>> 0;
        if (!noAssert) checkOffset(offset, 2, this.length);
        return (this[offset] << 8) | this[offset + 1];
      };
    Buffer13.prototype.readUint32LE = Buffer13.prototype.readUInt32LE =
    ...
    Buffer13.prototype.readUint32BE = Buffer13.prototype.readUInt32BE =
    ...
    Buffer13.prototype.readBigUInt64LE = defineBigIntMethod(
    ...
    Buffer13.prototype.readBigUInt64BE = defineBigIntMethod(
    ...
    Buffer13.prototype.readIntLE = function readIntLE(
      offset,
      byteLength2,
      noAssert,
    ) {
    ...
    Buffer13.prototype.readIntBE = function readIntBE(
      offset,
      byteLength2,
      noAssert,
    ) {
    ...
    Buffer13.prototype.readBigInt64LE = defineBigIntMethod(
    ...
    Buffer13.prototype.readBigInt64BE = defineBigIntMethod(
    ...
    Buffer13.prototype.writeUintLE = Buffer13.prototype.writeUIntLE =
    ...
    Buffer13.prototype.writeUintBE = Buffer13.prototype.writeUIntBE =
    ...
    Buffer13.prototype.writeUint8 = Buffer13.prototype.writeUInt8 =
    ...
    Buffer13.prototype.writeUint16LE = Buffer13.prototype.writeUInt16LE =
    ...
    Buffer13.prototype.writeUint16BE = Buffer13.prototype.writeUInt16BE =
    ...
    Buffer13.prototype.writeUint32LE = Buffer13.prototype.writeUInt32LE =
    ...
    Buffer13.prototype.writeUint32BE = Buffer13.prototype.writeUInt32BE =
    ...
    Buffer13.prototype.writeBigUInt64LE = defineBigIntMethod(
    ...
    Buffer13.prototype.writeBigUInt64BE = defineBigIntMethod(
    ...
    Buffer13.prototype.writeIntLE = function writeIntLE(
      value,
      offset,
      byteLength2,
      noAssert,
    ...
    Buffer13.prototype.writeIntBE = function writeIntBE(
      value,
      offset,
      byteLength2,
      noAssert,
    ...
    Buffer13.prototype.writeInt16LE = function writeInt16LE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeInt16BE = function writeInt16BE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeInt32LE = function writeInt32LE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeInt32BE = function writeInt32BE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeBigInt64LE = defineBigIntMethod(
    ...
    Buffer13.prototype.writeBigInt64BE = defineBigIntMethod(
    ...
    Buffer13.prototype.writeFloatLE = function writeFloatLE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeFloatBE = function writeFloatBE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeDoubleLE = function writeDoubleLE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.writeDoubleBE = function writeDoubleBE(
      value,
      offset,
      noAssert,
    ) {
    ...
    Buffer13.prototype.fill = function fill(val, start, end, encoding) {
      ...
      if (typeof val === "number") {
        ...
        const bytes2 = Buffer13.isBuffer(val)
          ? val
          : Buffer13.from(val, encoding);
  ...
  "node_modules/@stablelib/chacha20poly1305/lib/chacha20poly1305.js"(exports) {
    ...
    var ChaCha20Poly13052 =
      ...
      (function () {
        ...
        ChaCha20Poly13053.prototype.seal = function (
          nonce,
          plaintext,
          associatedData,
          dst,
        ...
        ChaCha20Poly13053.prototype.open = function (
          nonce,
          sealed,
          associatedData,
          dst,
        ...
        ChaCha20Poly13053.prototype._authenticate = function (
          tagOut,
          authKey,
          ciphertext,
          associatedData,
...
function bls(CURVE) {
  ...
  function calcPairingPrecomputes(p) {
    ...
    for (let i = BLS_X_LEN2 - 2; i >= 0; i--) {
      ...
      Ry = Fp22.sub(
        Fp22.sqr(Fp22.div(Fp22.add(t0, t3), _2n4)),
        Fp22.mul(Fp22.sqr(t2), _3n3),
      );
      Rz = Fp22.mul(t0, t4);
      if (bitGet(CURVE.params.x, i)) {
        ...
        let t5 = Fp22.add(
          Fp22.sub(t32, Fp22.mul(t42, _2n4)),
          Fp22.mul(Fp22.sqr(t02), Rz),
        );
        Rx = Fp22.mul(t12, t5);
  ...
  function aggregateShortSignatures(signatures) {
    ...
    const agg = signatures
      .map(normP12)
      .reduce((sum, s) => sum.add(s), G1.ProjectivePoint.ZERO);
    const aggAffine = agg;
...
var Fp2 = {
  ...
  div: (lhs, rhs) =>
    Fp2.mul(
      lhs,
      typeof rhs === "bigint" ? Fp.inv(Fp.create(rhs)) : Fp2.inv(rhs),
    ),
  inv: ({ c0: a, c1: b }) => {
...
var Fp6 = {
  ...
  div: (lhs, rhs) =>
    Fp6.mul(
      lhs,
      typeof rhs === "bigint" ? Fp.inv(Fp.create(rhs)) : Fp6.inv(rhs),
    ),
...
var Fp12 = {
  ...
  div: (lhs, rhs) =>
    Fp12.mul(
      lhs,
      typeof rhs === "bigint" ? Fp.inv(Fp.create(rhs)) : Fp12.inv(rhs),
    ),
...
function psi(x, y) {
  const x2 = Fp12.mul(Fp12.frobeniusMap(Fp12.multiplyByFp2(wsq_inv, x), 1), wsq)
    .c0.c0;
  const y2 = Fp12.mul(Fp12.frobeniusMap(Fp12.multiplyByFp2(wcu_inv, y), 1), wcu)
    .c0.c0;
  return [x2, y2];
}
function G2psi(c, P) {
...
var COMPRESSED_ZERO = setMask(Fp.toBytes(_0n5), {
  infinity: true,
  compressed: true,
});
...
var bls12_381 = bls({
  ...
  G1: {
    ...
    isTorsionFree: (c, point) => {
      ...
      const phi = new c(
        Fp.mul(point.px, cubicRootOfUnityModP),
        point.py,
        point.pz,
      );
    ...
    fromBytes: (bytes2) => {
      ...
      if (value.length === 48 && compressed) {
        ...
        if ((y * _2n5) / P !== BigInt(sort)) y = Fp.neg(y);
  ...
  G2: {
    ...
    fromBytes: (bytes2) => {
      ...
      if (value.length === 96 && compressed) {
        ...
        const Y_bit =
          y.c1 === _0n5 ? (y.c0 * _2n5) / P : (y.c1 * _2n5) / P ? _1n5 : _0n5;
    ...
    toBytes: (c, point, isCompressed) => {
      ...
      if (isCompressed) {
        if (isZero)
          return concatBytes(COMPRESSED_ZERO, numberToBytesBE(_0n5, len));
        const flag = Boolean(
          y.c1 === _0n5 ? (y.c0 * _2n5) / P : (y.c1 * _2n5) / P,
        );
        return concatBytes(
...
function roundAt(time, chain) {
  ...
  return (
    Math.floor((time - chain.genesis_time * 1e3) / (chain.period * 1e3)) + 1
  );
}
...
var HttpChain = class {
  ...
  async info() {
    const chainInfo = await jsonOrError(
      `${this.baseUrl}/info`,
      this.httpOptions,
    );
    if (
...
function isValidInfo(chainInfo, validParams) {
  return (
    chainInfo.hash === validParams.chainHash &&
    chainInfo.public_key === validParams.publicKey
  );
}
...
function isUnchainedBeacon(value, info) {
  return (
    ...
    !!value.randomness &&
    !!value.signature &&
    value.previous_signature === void 0 &&
    value.round > 0
  );
}
...
function isG1Rfc9380(value, info) {
  return (
    info.schemeID === "bls-unchained-g1-rfc9380" &&
    !!value.randomness &&
    !!value.signature &&
    value.previous_signature === void 0 &&
    value.round > 0
...
async function verifyBeacon(chainInfo, beacon, expectedRound) {
  ...
  if (isChainedBeacon(beacon, chainInfo)) {
    return bls12_381.verify(
      beacon.signature,
      await chainedBeaconMessage(beacon),
      publicKey,
    );
  }
  if (isUnchainedBeacon(beacon, chainInfo)) {
    return bls12_381.verify(
      beacon.signature,
      await unchainedBeaconMessage(beacon),
      publicKey,
    );
  }
  if (isG1G2SwappedBeacon(beacon, chainInfo)) {
    return verifySigOnG1(
      beacon.signature,
      await unchainedBeaconMessage(beacon),
      publicKey,
    );
  ...
  console.error(
    `Beacon type ${chainInfo.schemeID} was not supported or the beacon was not of the purported type`,
  );
  return false;
}
function normP1(point) {
  return point instanceof bls12_381.G1.ProjectivePoint
    ? point
    : bls12_381.G1.ProjectivePoint.fromHex(point);
}
function normP2(point) {
  return point instanceof bls12_381.G2.ProjectivePoint
    ? point
    : bls12_381.G2.ProjectivePoint.fromHex(point);
}
function normP1Hash(point, domainSeparationTag) {
  return point instanceof bls12_381.G1.ProjectivePoint
    ? point
    : bls12_381.G1.hashToCurve(point, { DST: domainSeparationTag });
}
async function verifySigOnG1(
  signature,
  message,
  publicKey,
...
async function randomnessIsValid(beacon) {
  const expectedRandomness = sha256(
    import_buffer.Buffer.from(beacon.signature, "hex"),
  );
  return (
    import_buffer.Buffer.from(beacon.randomness, "hex").compare(
      expectedRandomness,
    ) == 0
  );
}
...
async function encryptOnG1(master, ID, msg) {
  ...
  const Qid = PointG2.hashToCurve(ID, {
    DST: "BLS_SIG_BLS12381G2_XMD:SHA-256_SSWU_RO_NUL_",
  });
...
function createTimelockEncrypter(client2, roundNumber) {
  if (roundNumber < 1) {
    throw Error(
      "You cannot encrypt for a roundNumber less than 1 (genesis = 0)",
    );
  }
  return async (fileKey) => {
    ...
    switch (chainInfo.schemeID) {
      ...
      default:
        throw Error(
          `Unsupported scheme: ${chainInfo.schemeID} - you must use a drand network with an unchained scheme for timelock encryption!`,
        );
    }
    return [
      {
...
function serialisedCiphertext(ciphertext) {
  return import_buffer4.Buffer.concat([
    ciphertext.U,
    ciphertext.V,
    ciphertext.W,
  ]);
...
var STREAM = class _STREAM {
  static seal(plaintext, privateKey) {
    ...
    for (let chunk64kb = 1; chunk64kb <= chunks; chunk64kb++) {
      ...
      const output2 = ciphertext.subarray(
  ...
  encryptChunk(chunk, isLast, output2) {
    ...
    const ciphertext = new import_chacha20poly1305.ChaCha20Poly1305(
      this.key,
    ).seal(this.nonce, chunk);
  ...
  decryptChunk(chunk, isLast, output2) {
    ...
    if (this.nonce[11] === 1) throw new Error("Last chunk has been processed");
    if (isLast) this.nonce[11] = 1;
    const plaintext = new import_chacha20poly1305.ChaCha20Poly1305(
      this.key,
    ).open(this.nonce, chunk);
    if (plaintext == null) {
...
function createMacKey(fileKey, macMessage, headerText) {
  const hmacKey = hkdf(
    ...
    fileKey,
    "",
    import_buffer6.Buffer.from(macMessage, "utf8"),
    32,
  );
  return import_buffer6.Buffer.from(
    hmac(sha256, hmacKey, import_buffer6.Buffer.from(headerText, "utf8")),
  );
}
...
function readAge(input) {
  ...
  const mac2 = import_buffer7.Buffer.from(
    macLine.slice(macStartingTag.length, macLine.length),
    "base64",
  );
  const ciphertext = import_buffer7.Buffer.from(
    lines.join("\n") ?? "",
    "binary",
  );
  return {
...
function parseRecipients(lines) {
  ...
  for (
    ...
    recipients2.push({
      type,
      args,
      body: import_buffer7.Buffer.from(body, "base64"),
    });
  }
...
async function encryptedPayload(fileKey, payload) {
  ...
  const hkdfKey = hkdf(
    ...
    fileKey,
    nonce,
    import_buffer8.Buffer.from(hkdfBodyMessage, "utf8"),
    hkdfKeyLengthBytes,
  );
...
async function decryptAge(payload, unwrapFileKey = NoOpEncDec.unwrap) {
  ...
  const expectedMac = unpaddedBase64Buffer(
    createMacKey(fileKey, headerMacMessage, header3),
  );
  ...
  const nonce = import_buffer8.Buffer.from(
    encryptedPayload2.body.slice(0, bodyHkdfNonceLengthBytes),
  );
...
function encodeArmor(input, chunkSize = 64) {
  const base64Input = import_buffer9.Buffer.from(input, "binary").toString(
    "base64",
  );
...
function decodeArmor(armor, chunkSize = 64) {
  ...
  if (!armor.startsWith(header2)) {
    throw Error(
      `Armor cannot be decoded if it does not start with a header! i.e. ${header2}`,
    );
  }
...
function createTimelockDecrypter(network) {
  return async (recipients2) => {
    ...
    if (roundTime(chainInfo, roundNumber) > Date.now()) {
      throw Error(
        `It's too early to decrypt the ciphertext - decryptable at round ${roundNumber}`,
      );
    }
    ...
    switch (chainInfo.schemeID) {
      case "pedersen-bls-unchained": {
        const ciphertext = parseCiphertext(
          body,
          bls12_381.G1.ProjectivePoint.BASE,
        );
        return await decryptOnG1(
          import_buffer10.Buffer.from(beacon.signature, "hex"),
          ciphertext,
        );
      }
      case "bls-unchained-on-g1": {
      ...
      default:
        throw Error(
          `Unsupported scheme: ${chainInfo.schemeID} - you must use a drand network with an unchained scheme for timelock decryption!`,
        );
    }
  };
  function parseRoundNumber(args) {
    ...
    if (roundNumberParsed !== roundNumberParsed) {
      throw Error(
        `Expected the roundNumber arg to be a number, but it was ${roundNumber}!`,
      );
    }
...
async function encrypt(args) {
  ...
  const ciphertextHex = import_buffer11.Buffer.from(
    ageBinary,
    "binary",
  ).toString("hex");
...
async function decrypt(args) {
  ...
  const ageBinary = import_buffer11.Buffer.from(
    args.ciphertextHex,
    "hex",
  ).toString("binary");
...
export { decrypt, encrypt, fetchRound };
