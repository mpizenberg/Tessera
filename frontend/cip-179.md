...
- The role derived from the voter tag (mapping above) matches the claimed role, necessarily one of `{DRep, SPO, CC}`, the roles with a Conway voter type; Stakeholder and Owner can never bind.
