...
On preview, the command built the stores for a survey created in 1365 with
`E` = 1395 from the 1119 set, and the verifier's rebuild from them matched
the survey's `artifactHash`.
