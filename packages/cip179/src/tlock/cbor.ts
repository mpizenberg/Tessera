/**
 * CBOR (de)serialization of a CIP-179 {@link Metadatum} tree — evolution-sdk is
 * the CBOR provider and stays isolated here. The `cip-179` codec is deliberately
 * CBOR-free; this is where a metadatum tree becomes bytes and back.
 *
