 ...
 * carries the response/cancellation doesn't attach it. A data source obtains the
 * script CBOR by hash (e.g. Kupo's `/scripts/{hash}`) and folds the result into the
