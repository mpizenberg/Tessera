...
| `packages/amaru-store-reader` | The verifier's ledger inputs read from an Amaru node's own epoch snapshots, a Rust crate outside the pnpm workspace; in progress (its README).                                                                                                          |
